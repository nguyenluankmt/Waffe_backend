...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-md">
                    ...
                    <div class="container-fluid">
                        <div class="clearfix navbar-fixed-top">
                            ...
                            <a id="index" class="page-logo" href="index.html">
                                <img src="{{ URL::asset('Backend/assets/layouts/layout5/img/logo.png" alt="Logo"> </a>
                            <!-- END LOGO -->
                            <!-- BEGIN SEARCH -->
        ...
        <script src="{{ URL::asset('Backend/assets/pages/scripts/table-datatables-managed.min.js') }}" type="text/javascript"></script>
